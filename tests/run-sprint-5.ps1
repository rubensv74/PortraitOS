...
# ============================================================
# PortraitOS Sprint 5 — Portrait Contract Completion (HTTP)
# ------------------------------------------------------------
# Sirve el repositorio en un puerto libre con HttpListener y
# ejecuta tests/sprint-5-runner.html en Chrome headless.
# ============================================================
...
$runnerName = "sprint-5-runner.html"
$temporaryRoot = Join-Path $env:TEMP ("portraitos-sprint-5-" + [guid]::NewGuid().ToString("N"))
